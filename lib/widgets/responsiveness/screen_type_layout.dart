  ...
  Widget build(BuildContext context) {
    return ResponsiveLayoutBuilder(
      builder: (context, sizingInformation) {
        ...
        // Return mobile layout if sizing indicates mobile or nothing else is supplied
        return mobile;
      },
    );
  }
